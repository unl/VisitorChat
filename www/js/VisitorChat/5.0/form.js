...
;(function($) {
    ...
    */
    ...
    //This is my own test for ajax thingy
    // This is for deep Extend
     ...
     */
    function myFormToArray(semantic){
         var a = [];
        if (this.length === 0) {
            return a;
        }
    ...
    function myFieldValue(el,successful){
    ...
    function myClearForm(includeHidden){
    ...
    // My own get parents for the mySelected function
    ...
    // Not so sure how to fix somethin like this
    function mySelected(select){
        if (select === undefined) {
            select = true;
        }
        return this.each(function() {
    ...
    // expose debug var (Needed to move to js)
