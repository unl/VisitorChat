<div id='visitorChat_confirmationContainer'>
    ...
    <form id='visitorChat_confirmationEamilForm' action="<?php echo UNL\VisitorChat\Controller::$URLService->generateSiteURL('conversation/' . $context->conversation->id . '/sendConfirmEmail', true, true)?>" class='unl_visitorchat_form' method="POST">
        <fieldset>
