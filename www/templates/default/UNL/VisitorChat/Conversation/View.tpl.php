...
<div id="visitorChat_conversation">
    ...
    <div class="dcf-relative dcf-mb-3 dcf-overflow-x-hidden dcf-overflow-y-scroll dcf-z-0 dcf-txt-sm" id="visitorChat_chatBox" role="log" tabindex="0" aria-live="polite">
